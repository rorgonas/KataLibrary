...
class Page {
	...
	public static function AsideNavList() {
		...
		$output .=		'<li><a href="http://localhost:8080/KataLibrary/resource/template/qunit.tpl.php" alt="FizzBuzz">Fizz</a></li>';
		$output .=		'<li><a href="apps/RomanNumbers/index.php" alt="RomanNumbers">Roman Numbers</a></li>';
		$output .=		'<li><a href="apps/CalcStats/index.php" alt="CalcStats">Calculate Statistics</a></li>';
		$output .=		'<li><a href="apps/LCDDigits/index.php" alt="LCDDigits">LCD Digits</a></li>';
		$output .=		'<li class="nav-header">PHP5 & PHPUnit group</li>';
		$output .=		'<li><a href="http://localhost:8080/KataLibrary/plugin/vpu/" alt="PrimeNumber">Prime Numbers</a></li>';
		$output .=		'<li><a href="http://localhost:8080/KataLibrary/plugin/vpu/" alt="BowlingGame">Bowling Game</a></li>';
		$output .=		'<li><a href="http://localhost:8080/KataLibrary/plugin/vpu/" alt="OverlappingRectangles">Overlapping rectangles</a></li>';
		$output .= 	'</ul>';
		$output .= '</nav>';
		return $output;
	}
